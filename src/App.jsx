...
const COUNTRY_DATA = {
  "Uruguay":        { flag:"🇺🇾", currency:"UYU", shipping:"Envío express 24-48hs",       note:"Precios en pesos uruguayos con IVA incluido",              popular:["VITA XTRA T+","THERMO T3","NUTRADAY"],           unavailable:["Rexet","Pre Sport","Xpeed","Alpha Balance"] },
          ...
          {catalogOpen&&(
            <div style={{marginTop:32}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))",gap:16}}>
                {filtProds.map(p=>{const isUnavail=selectedCountry&&COUNTRY_DATA[selectedCountry]?.unavailable?.includes(p.name);return(
