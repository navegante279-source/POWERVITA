...
const PRODUCTS = [
  ...
  { id:2,  name:"Liquid Fiber",       line:"Detox",   color:"#2d6a4f", bg:"#f0f7f3", img:null,                                                emoji:"🍋", tag:"Digestión puntual",               desc:"Fibra prebiótica soluble que regula el ritmo digestivo y reduce la absorción de grasas.", benefits:["Regula la digestión","Nutre la flora intestinal","Reduce absorción de grasas"],                              ing:"Inulina · Oligofructuosa · Raíz de achicoria" },
  ...
  { id:4,  name:"Prunex1",            line:"Detox",   color:"#2d6a4f", bg:"#f0f7f3", img:null,                                                emoji:"🫐", tag:"Limpieza natural",                desc:"Té herbal de fibras solubles que libera el tránsito intestinal lento y reduce la hinchazón abdominal.", benefits:["Regula el tránsito intestinal","Reduce la hinchazón","Elimina desechos perjudiciales"],              ing:"Psyllium · Inulina · Mucílago de linaza · Guindón · Anís estrella" },
  { id:5,  name:"Alpha Balance",      line:"Detox",   color:"#2d6a4f", bg:"#f0f7f3", img:null,                                                emoji:"🥬", tag:"Cuerpo alcalino",                 desc:"Bebida alcalinizante con vegetales verdes ricos en clorofila que equilibra el pH y elimina toxinas del organismo.", benefits:["Alcaliniza el organismo","Equilibra el pH","Elimina residuos tóxicos"],                       ing:"Alfalfa · Espirulina · Chlorella · Pasto de trigo · Espinaca · Jengibre" },
  { id:6,  name:"Berry Balance",      line:"Detox",   color:"#2d6a4f", bg:"#f0f7f3", img:null,                                                emoji:"🫒", tag:"Protege el tracto urinario",      desc:"Concentrado de antioxidantes de berries que protege el sistema urinario, previene molestias y evita la retención de líquidos.", benefits:["Protege el tracto urinario","Evita retención de líquidos","Equilibra el pH urinario"], ing:"Cranberry · Berries tropicales · Probióticos · Antocianina · Calcio orgánico" },
  { id:7,  name:"Biopro+ Tect",       line:"Protein", color:"#1565C0", bg:"#f0f4fb", img:null,                                                emoji:"🛡️", tag:"Activa tus defensas",            desc:"Batido con Bioprotein+ Colostrum® patentado que activa el sistema de defensas y regenera las células.", benefits:["Eleva defensas inmunitarias","Regeneración celular","Fortalece huesos"],                             ing:"Bioprotein+ Colostrum® · Bioferrín® · Aminoácidos · Calcio lácteo · DHA" },
  { id:8,  name:"Protein Active",     line:"Protein", color:"#1565C0", bg:"#f0f4fb", img:null,                                                emoji:"💪", tag:"Nutrición vegetal avanzada",      desc:"Proteína 100% vegetal de quinua germinada y arroz integral que regenera tejidos y reduce el daño oxidativo.", benefits:["100% vegetal y sin lactosa","Regenera tejidos","Reduce daño oxidativo"],                         ing:"Quinua germinada · Arroz integral · Arveja · Algas · DHA · Aceite de coco" },
  { id:9,  name:"Nutraday",           line:"Energy",  color:"#7B3FA0", bg:"#f5f0f9", img:null,                                                emoji:"⚡", tag:"Vitalidad familiar",              desc:"Refresco multivitamínico con moringa, camu camu y quinua germinada ideal para toda la familia.", benefits:["12 vitaminas + 5 minerales","Fortalece las defensas","Desarrollo físico y mental"],                    ing:"Moringa · Guayaba · Camu Camu · Açaí · Quinua germinada" },
  { id:10, name:"Vita Xtra T+",       line:"Energy",  color:"#7B3FA0", bg:"#f5f0f9", img:"https://powervita.vercel.app/vitaxtra.jpg",          emoji:"🌟", tag:"Elimina la fatiga",              desc:"Energizante con guayusa, ginseng y cordyceps que elimina la fatiga física y mental y reduce la oxidación celular.", benefits:["Energía sostenida todo el día","Alto poder antioxidante","Elimina fatiga física y mental"], ing:"Guayusa · Té verde · Açaí · Goji berry · Cordyceps · Maca · Ginseng" },
  { id:11, name:"Vitaenergia",        line:"Energy",  color:"#7B3FA0", bg:"#f5f0f9", img:null,                                                emoji:"🔥", tag:"Energía y vitalidad",              desc:"Bebida multivitamínica con antocianina de maíz morado y açaí que disipa la fatiga y refuerza el sistema inmune.", benefits:["Disipa la fatiga","Mejora asimilación de proteínas","Refuerza el sistema inmune"],         ing:"Aminoácidos · Vitaminas · Antocianina maíz morado · Açaí · Camu camu · Luteína" },
  { id:12, name:"Xpeed",              line:"Energy",  color:"#7B3FA0", bg:"#f5f0f9", img:null,                                                emoji:"🚀", tag:"Energía inmediata",               desc:"Bebida energizante natural gasificada con mix ancestral de maca, guaraná y teína. Sin azúcar, lista para consumir.", benefits:["Energía inmediata","Contrarresta la fatiga","Efecto sparkling natural"],                        ing:"Maca · Guaraná · Teína · Taurina · Vitamina C · Vitamina B5" },
  { id:13, name:"Xpeed Citrus Power", line:"Energy",  color:"#7B3FA0", bg:"#f5f0f9", img:null,                                                emoji:"🍋", tag:"Energía sabor cítrico",           desc:"Versión sin azúcar de Xpeed con sabor a limón y el mismo mix energético ancestral para vivir al máximo.", benefits:["Sin azúcar","Energía natural sostenida","Sabor limón refrescante"],                              ing:"Maca · Guaraná · Teína · Taurina · Vitamina C · Vitamina B5" },
  { id:14, name:"Vera+",              line:"Immunity",color:"#00897B", bg:"#f0faf8", img:null,                                                emoji:"🛡️", tag:"Defensas inteligentes",           desc:"Aloe vera, beta glucanos y extracto de hoja de oliva que fortalecen el sistema inmune y reducen el daño oxidativo.", benefits:["Mantiene defensas activas","Reduce deterioro celular","Fortalece el sistema inmune"],     ing:"Aloe vera · Beta glucanos · N-acetilcisteína · Extracto hoja de oliva · Amalaki" },
  { id:15, name:"Gano+ T",            line:"Immunity",color:"#00897B", bg:"#f0faf8", img:null,                                                emoji:"🍵", tag:"Optimiza tu protección",          desc:"Té de Ganoderma Lucidum y té blanco que modula el sistema inmunológico y neutraliza radicales libres.", benefits:["Mantiene defensas activas","Modula el sistema inmune","Neutraliza radicales libres"],             ing:"Ganoderma Lucidum · Extracto de té blanco · Vitamina C y D" },
  { id:16, name:"Gano+ Cappuccino",   line:"Immunity",color:"#00897B", bg:"#f0faf8", img:null,                                                emoji:"☕", tag:"Cappuccino inmunoprotector",      desc:"Café cappuccino con Ganoderma Lucidum, el hongo milenario del secreto de la longevidad asiática.", benefits:["Antioxidante celular","Modula las defensas naturales","Reduce daño oxidativo"],                     ing:"Ganoderma Lucidum · Quillay · Micronutrientes" },
  { id:17, name:"Café Ganomax",       line:"Immunity",color:"#00897B", bg:"#f0faf8", img:null,                                                emoji:"☕", tag:"Café premium inmunológico",       desc:"Café gourmet colombiano con Ganoderma Lucidum y Uña de Gato amazónica para reforzar y regular el sistema inmune.", benefits:["Refuerza el sistema inmune","Reduce daño oxidativo","Mantiene la vitalidad"],          ing:"Café tostado · Ganoderma Lucidum · Uña de gato" },
  { id:18, name:"Thermo T3",          line:"Control", color:"#E65100", bg:"#fdf4ef", img:"https://powervita.vercel.app/thermo.jpg",            emoji:"🔥", tag:"Activa tu metabolismo",          desc:"Mix de tres tés con L-Carnitina y Garcinia Cambogia que transforma la grasa en energía y reduce medidas corporales.", benefits:["Activa la termogénesis","Quema grasa naturalmente","Control de peso efectivo"],          ing:"Té verde · Té negro · Té rojo · Carnitina · Garcinia Cambogia · Café verde" },
  { id:19, name:"Nocarb-T",           line:"Control", color:"#E65100", bg:"#fdf4ef", img:null,                                                emoji:"🌾", tag:"Carbohidratos bajo control",      desc:"Fórmula de fibras solubles, cromo y té verde que reduce la elevación de glucosa tras las comidas y controla el peso.", benefits:["Controla los carbohidratos","Mantiene niveles de glucosa","Reduce acumulación de grasa"], ing:"Fibra de yacón · Acacia · Inulina · Pectina de manzana · Canela · Té verde · Cromo" },
  { id:20, name:"Chocolate Fit",      line:"Control", color:"#E65100", bg:"#fdf4ef", img:null,                                                emoji:"🍫", tag:"Mantente en forma deliciosamente", desc:"Bebida vegetal de cacao puro amazónico con CLA que acelera el metabolismo, reduce medidas y calma la ansiedad.", benefits:["Reduce medidas corporales","Calma la ansiedad por comer","Acelera el metabolismo"],           ing:"Cacao puro amazónico · Proteína vegetal · Café verde · CLA · Cromo orgánico" },
  { id:21, name:"Café & Café Fit",    line:"Control", color:"#E65100", bg:"#fdf4ef", img:null,                                                emoji:"☕", tag:"Café sin perder la línea",         desc:"Café gourmet enriquecido con extracto de café verde que apoya el control de peso y reduce el apetito.", benefits:["Apoya control de peso","Reduce sensación de apetito","Reduce cansancio y fatiga"],               ing:"Café tostado liofilizado · Extracto de café verde" },
  { id:22, name:"Café Fit Cappuccino",line:"Control", color:"#E65100", bg:"#fdf4ef", img:null,                                                emoji:"☕", tag:"Cappuccino sin culpa",            desc:"Cappuccino gourmet bajo en calorías con café verde Svetol® para controlar el peso sin renunciar al placer.", benefits:["Bajo en calorías","Controla peso y medidas","Reduce el apetito"],                              ing:"Café tostado · Café verde Svetol® · Leche descremada · Crema para café" },
  { id:23, name:"Biopro+ Fit",        line:"Control", color:"#E65100", bg:"#fdf4ef", img:null,                                                emoji:"⚖️", tag:"Nutrición y reduce medidas",      desc:"Batido proteico con Prolibra® clínicamente probado que acelera el metabolismo de la grasa y tonifica el músculo.", benefits:["Acelera metabolismo de grasa","Tonifica la masa muscular","Reduce sensación de apetito"],  ing:"Bioprotein+ Colostrum® · Prolibra® · Aminoácidos · Tamarindo Malabar · DHA" },
  { id:24, name:"Protein Active Fit", line:"Control", color:"#E65100", bg:"#fdf4ef", img:"https://powervita.vercel.app/protein.jpg",           emoji:"💪", tag:"Proteína vegetal fit",           desc:"Proteína 100% vegetal con L-Carnitina y Tamarindo Malabar para controlar el peso, tonificar y reducir medidas.", benefits:["100% vegetal y sin lactosa","Controla peso y medidas","Tonifica los músculos"],              ing:"Quinua germinada · Arveja · Arroz integral · L-Carnitina · Cromo · Zinc orgánico" },
  { id:25, name:"Protein Xoup",       line:"Control", color:"#E65100", bg:"#fdf4ef", img:null,                                                emoji:"🍲", tag:"Sopas proteicas fit",              desc:"Sopas instantáneas de proteína vegetal con Slendesta® que aumenta la saciedad y CLA que previene acumulación de grasa.", benefits:["Alta saciedad con Slendesta®","Previene acumulación de grasa","Nutrición muscular activa"], ing:"Bioprotein Active® · Slendesta® · CLA · Hierro · Zinc · Magnesio" },
  { id:26, name:"Probal",             line:"Immunity",color:"#00897B", bg:"#f0faf8", img:null,                                                emoji:"🌸", tag:"Salud femenina integral",         desc:"Té herbal con aguaje y ashwagandha que controla las molestias del período y balancea la menopausia.", benefits:["Refuerza la salud femenina","Controla molestias del período","Balance durante la menopausia"],    ing:"Aguaje · Dong Quai · Orégano · Triptófano · Magnesio · Camu-camu · Luteína" },
  { id:27, name:"Passion",            line:"Energy",  color:"#7B3FA0", bg:"#f5f0f9", img:null,                                                emoji:"🔆", tag:"Incrementa tu vigor",             desc:"Aminoácidos, jalea real, maca y ginseng que mejoran el vigor, la vitalidad y la energía de manera natural.", benefits:["Mejora la vitalidad","Incrementa la energía","Vigoriza el cuerpo"],                              ing:"Aminoácidos · Jalea real · Maca · Ginseng · Zinc orgánico" },
  { id:28, name:"Youth Elixir",       line:"Immunity",color:"#00897B", bg:"#f0faf8", img:null,                                                emoji:"✨", tag:"Activa tu juventud",              desc:"Resveratrol de uva y súper frutas que reducen radicales libres, mejoran el sueño y previenen el envejecimiento prematuro.", benefits:["Anti-envejecimiento celular","Mejora el sueño profundo","Mayor elasticidad de piel"],     ing:"Resveratrol · Aminoácidos · Optiberry® · Blueberries · Sauco · Amalaki" },
  { id:29, name:"Golden FLX",         line:"Immunity",color:"#00897B", bg:"#f0faf8", img:null,                                                emoji:"🌿", tag:"Flexibilidad articular",          desc:"Té de cúrcuma orgánica con jengibre y leche de coco que previene molestias articulares y mejora la movilidad.", benefits:["Previene molestias articulares","Mejora flexibilidad y movilidad","Controla procesos oxidativos"], ing:"Cúrcuma · Jengibre · Cardamomo · Leche de coco · Pimienta negra · Canela" },
  { id:30, name:"Beauty-In",          line:"Immunity",color:"#00897B", bg:"#f0faf8", img:null,                                                emoji:"💆", tag:"Belleza desde adentro",           desc:"Péptidos de colágeno bioactivo 4x más potentes que el colágeno convencional para piel firme, cabello y uñas fuertes.", benefits:["Piel más firme y elástica","Fortalece cabello y uñas","Previene envejecimiento prematuro"], ing:"Péptidos colágeno bioactivo · Coenzima Q10 · Biotina natural · Vitaminas C y E · Zinc" },
  { id:31, name:"On",                 line:"Mental",  color:"#E53935", bg:"#fff0f0", img:null,                                                emoji:"🧠", tag:"Mente activa y alerta",           desc:"GABA, yerba mate y DHA que activan la mente, mejoran la función cognitiva y mantienen el enfoque sin causar somnolencia.", benefits:["Mente activa y alerta","Mejora función cognitiva","Nutre el cerebro"],                     ing:"GABA · Taurina · Yerba mate · Açaí · Camu camu · Vitaminas B · DHA · ARA" },
  { id:32, name:"No Stress",          line:"Mental",  color:"#E53935", bg:"#fff0f0", img:null,                                                emoji:"🧘", tag:"Equilibrio mental",               desc:"Aminoácidos esenciales con ashwagandha que reducen el estrés y mejoran la concentración sin causar somnolencia.", benefits:["Reduce el estrés y ansiedad","Mantiene concentración y enfoque","Mejora la relajación"],     ing:"L-Teanina · Glicina · Triptófano · Ashwagandha · Amalaki · Magnesio · Vitaminas B" },
  { id:33, name:"Pre Sport",          line:"Sport",   color:"#546E7A", bg:"#f0f4f5", img:null,                                                emoji:"🏃", tag:"Prepara tu cuerpo",               desc:"Electrolitos y aminoácidos que mejoran el rendimiento, aumentan la resistencia y reducen la fatiga pre-entrenamiento.", benefits:["Energía explosiva pre-entreno","Mayor resistencia y vasodilatación","Hidratación con electrolitos"], ing:"Citrulina de sandía · β-Alanina · L-Creatina nitrato · Mix isotónico · Hierba mate" },
  { id:34, name:"Xtra Mile",          line:"Sport",   color:"#546E7A", bg:"#f0f4f5", img:null,                                                emoji:"🚴", tag:"Energía sostenida",               desc:"Palatinose® de bajo índice glucémico y agua de coco amazónico para energía balanceada y sostenida durante el ejercicio.", benefits:["Energía sostenida durante ejercicio","Hidratación eficiente","Reduce la fatiga"],        ing:"Palatinose® · Agua de coco amazónico · Sal de Maras · Mix de electrolitos · Zinc · Cromo" },
  { id:35, name:"Post Sport",         line:"Sport",   color:"#546E7A", bg:"#f0f4f5", img:null,                                                emoji:"🏋️", tag:"Recuperación muscular",           desc:"BCAAs, glutamina y agua de coco que reparan y fortalecen las fibras musculares después del entrenamiento intenso.", benefits:["Repara fibras musculares","Repone electrolitos naturalmente","Neutraliza el catabolismo"],  ing:"BCAAs · Glutamina · Acerola · Granada · Agua de coco" },
  { id:36, name:"Biopro+ Sport",      line:"Sport",   color:"#546E7A", bg:"#f0f4f5", img:null,                                                emoji:"💪", tag:"Músculos tonificados",            desc:"Batido proteico con Actinos® patentado que incrementa el flujo sanguíneo, genera masa muscular magra y mejora la recuperación.", benefits:["Genera masa muscular magra","Incrementa flujo sanguíneo","Mejora recuperación y oxigenación"], ing:"Bioprotein+ Colostrum® · Actinos® · Aminoácidos · Calcio lácteo · DHA" },
  { id:37, name:"Protein Active Sport",line:"Sport",  color:"#546E7A", bg:"#f0f4f5", img:null,                                                emoji:"🌱", tag:"Proteína vegetal deportiva",      desc:"Proteína 100% vegetal germinada con BCAAs y L-Glutamina para desarrollo muscular saludable y recuperación post-ejercicio.", benefits:["100% vegetal para deportistas","Recuperación muscular acelerada","Genera masa muscular magra"], ing:"Quinua germinada · Arveja · Arroz germinado · Algas · L-Glutamina · BCAAs" },
];
